...
import (
	...
	"github.com/dipper-iot/bozo/auth"
	"github.com/dipper-iot/bozo/auth/provider"
	"github.com/dipper-iot/bozo/broker"
	"github.com/dipper-iot/bozo/client"
	"github.com/dipper-iot/bozo/client/grpc"
	"github.com/dipper-iot/bozo/client/selector"
	"github.com/dipper-iot/bozo/config"
	configSrc "github.com/dipper-iot/bozo/config/source"
	configSrv "github.com/dipper-iot/bozo/config/source/service"
	"github.com/dipper-iot/bozo/debug/profile"
	"github.com/dipper-iot/bozo/debug/profile/http"
	"github.com/dipper-iot/bozo/debug/profile/pprof"
	"github.com/dipper-iot/bozo/debug/trace"
	"github.com/dipper-iot/bozo/logger"
	"github.com/dipper-iot/bozo/registry"
	registrySrv "github.com/dipper-iot/bozo/registry/service"
	"github.com/dipper-iot/bozo/runtime"
	"github.com/dipper-iot/bozo/server"
	"github.com/dipper-iot/bozo/store"
	"github.com/dipper-iot/bozo/transport"
	"github.com/dipper-iot/bozo/util/wrapper"

	// clients
	cgrpc "github.com/dipper-iot/bozo/client/grpc"
	cmucp "github.com/dipper-iot/bozo/client/mucp"

	// servers
	"github.com/micro/cli/v2"

	sgrpc "github.com/dipper-iot/bozo/server/grpc"
	smucp "github.com/dipper-iot/bozo/server/mucp"

	// brokers
	brokerHttp "github.com/dipper-iot/bozo/broker/http"
	"github.com/dipper-iot/bozo/broker/memory"
	"github.com/dipper-iot/bozo/broker/nats"
	brokerSrv "github.com/dipper-iot/bozo/broker/service"

	// registries
	"github.com/dipper-iot/bozo/registry/etcd"
	"github.com/dipper-iot/bozo/registry/mdns"
	rmem "github.com/dipper-iot/bozo/registry/memory"
	regSrv "github.com/dipper-iot/bozo/registry/service"

	// runtimes
	kRuntime "github.com/dipper-iot/bozo/runtime/kubernetes"
	lRuntime "github.com/dipper-iot/bozo/runtime/local"
	srvRuntime "github.com/dipper-iot/bozo/runtime/service"

	// selectors
	"github.com/dipper-iot/bozo/client/selector/dns"
	"github.com/dipper-iot/bozo/client/selector/router"
	"github.com/dipper-iot/bozo/client/selector/static"

	// transports
	thttp "github.com/dipper-iot/bozo/transport/http"
	tmem "github.com/dipper-iot/bozo/transport/memory"

	// stores
	memStore "github.com/dipper-iot/bozo/store/memory"
	svcStore "github.com/dipper-iot/bozo/store/service"

	// tracers
	// jTracer "github.com/dipper-iot/bozo/debug/trace/jaeger"
	memTracer "github.com/dipper-iot/bozo/debug/trace/memory"

	// auth
	jwtAuth "github.com/dipper-iot/bozo/auth/jwt"
	svcAuth "github.com/dipper-iot/bozo/auth/service"

	// auth providers
	"github.com/dipper-iot/bozo/auth/provider/basic"
	"github.com/dipper-iot/bozo/auth/provider/oauth"
)
